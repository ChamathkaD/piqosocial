                ...
                <ul class="space-y-6">
                    <li class="flex justify-between items-center">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3 leading-none">
                                <p>Administrator at <span class="font-semibold hover:underline">Mediaalent</span></p>
                    ...
                    <li class="flex justify-between items-center">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3 leading-none">
                                <p>Studied at <span class="font-semibold hover:underline">IJSE - Institute of Software
                                        Engineering</span></p>
                    ...
                    <li class="flex justify-between items-center">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <p>Lives in <span class="font-semibold hover:underline">Moratuwa, Sri Lanka</span></p>
                            </div>
                        </div>
                    ...
                    <li class="flex justify-between items-center">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <p>From <span class="font-semibold hover:underline">Deniyaya, Sri Lanka</span></p>
                            </div>
                        </div>
